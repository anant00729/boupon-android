package com.an2t.android.bouponapp.fcm_service;
...
//        }
    ...
    private void handleDataMessage(JSONObject json) {
        String correct_data = json.toString().replaceAll("=", ":");
        Log.e(TAG, "push json: " + correct_data);
        ...
        try {
            ...
            String fcm_token = payload.getString("team");
            String order_id = payload.getString("score");
